    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {isLoading ? (
          ...
          >
            {/* football stadium turf dark background */}
            <div className="absolute inset-0 z-0 opacity-20 mix-blend-overlay">
              <img 
                src="https://pixabay.com/get/g2a176dd246df9a05f48a16ee82fde260698c73b94ebd0b0d3778b5c4b30b8bb18fd7af02a9c8fd36a252d44e94a9995a9f1677ee732ff12b25251063e8fd6dc9_1280.jpg" 
            ...
            <div className="relative z-10 p-12 text-center flex flex-col items-center">
              ...
              <p className="text-muted-foreground max-w-md mx-auto mb-8 text-lg">
                Upload your first match video to extract professional-grade player statistics, heatmaps, and AI performance reports.
              </p>
              <button
                onClick={() => setIsUploadOpen(true)}
                className="px-8 py-4 rounded-xl font-bold bg-white text-background hover:bg-gray-200 transition-colors shadow-xl flex items-center gap-2"
              >
                <Plus className="w-5 h-5" />
                Upload Match Video
              </button>
