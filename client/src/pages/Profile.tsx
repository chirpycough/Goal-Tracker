...
export default function Profile() {
  ...
  const form = useForm<InsertUser>({
    ...
    defaultValues: {
      ...
      state: user?.state || "",
      matchVideosCount: user?.matchVideosCount || "",
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="Enter your full name" className="pl-10 bg-white/5 border-white/10" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="Enter your email" className="pl-10 bg-white/5 border-white/10" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="Enter your phone number" className="pl-10 bg-white/5 border-white/10" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="Enter your WhatsApp number" className="pl-10 bg-white/5 border-white/10" />
                        </div>
                      </FormControl>
                      <p className="text-xs text-muted-foreground mt-1">Include country code (e.g., +2348012345678)</p>
                      <FormMessage />
                    </FormItem>
                  )} />
                </CardContent>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="Enter your current club" className="pl-10 bg-white/5 border-white/10" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="Paste link to your video (YouTube, Google Drive, etc.)" className="pl-10 bg-white/5 border-white/10" />
                        </div>
                      </FormControl>
                      <p className="text-xs text-muted-foreground mt-1">Link to any highlight reel or match video</p>
                      <FormMessage />
                    </FormItem>
                  )} />
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="e.g. Instagram, friend, Google" className="pl-10 bg-white/5 border-white/10" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
